...
public class DeviceControlActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //customize line chart descriptions
        mChart.getDescription().setEnabled(true);
        mChart.getDescription().setText("Real Time ECG Graph");
    ...
    private void addEntry(){
        ...
        if (data !=null){
            ...
            mChart.moveViewToX(set.getXMax() - 50);
            }
        }
        //this is the code that actually creates the line
...
//clicking the button causes reading the value and starting the plotting
